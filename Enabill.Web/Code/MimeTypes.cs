...
namespace Enabill.Web
{
	public static class MimeTypes
	{
		...
		(
			uint pBC, [MarshalAs(UnmanagedType.LPStr)]
			string pwzUrl, [MarshalAs(UnmanagedType.LPArray)]
			byte[] pBuffer, uint cbSize, [MarshalAs(UnmanagedType.LPStr)]
			string pwzMimeProposed, uint dwMimeFlags, ref uint ppwzMimeOut, uint dwReserverd
		);
		...
		public static string GetContentType(string fileName)
		{
			...
			mimeTypes.TryGetValue(extension, out string contentType);
		...
		public static string GetExtension(string mimeType, string extension)
		{
			if (knownTypes == null || mimeTypes == null)
				InitializeMimeTypeLists();
			...
			return mimeTypes.FirstOrDefault(x => x.Value == mimeType && x.Key == extension).Key;
		}
