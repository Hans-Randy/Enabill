...
CREATE VIEW [dbo].[vwTicketsOverview_FCM]
/*------------------------------------------------------------------------
Create by:	Izaan Mobey
ON:			04 Oct 2013
Reason:		Ticket overview for FCM tickets for Nasiefa
...
--select * from dbo.vwTicketsOverview_FCM
AS
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[vwTicketsOverview_FCM] TO PUBLIC
    AS [dbo];
