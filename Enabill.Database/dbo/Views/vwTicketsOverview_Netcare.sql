...
CREATE VIEW [dbo].[vwTicketsOverview_Netcare]
/*------------------------------------------------------------------------
Create by:	Izaan Mobey
ON:			04 Oct 2013
Reason:		Ticket overview for Nectare tickets for Nasiefa
...
--select * from dbo.vwTicketsOverview_Netcare
AS
	...
	WHERE 
		C.ClientID = 20  --Netcare
	AND DateCreated >= '01-Sep-2013'
	ORDER BY 
		DateCreated
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[vwTicketsOverview_Netcare] TO PUBLIC
    AS [dbo];
