...
CREATE VIEW [dbo].[vwTicketsOverview_HSM]
/*------------------------------------------------------------------------
Create by:	Izaan Mobey
ON:			04 Oct 2013
Reason:		Ticket overview for HSM tickets for Nasiefa
...
--select * from dbo.vwTicketsOverview_HSM
AS
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[vwTicketsOverview_HSM] TO PUBLIC
    AS [dbo];
