...
CREATE VIEW [dbo].[vwTicketsOverview_Woolworths]
/*------------------------------------------------------------------------
Create by:	Izaan Mobey
ON:			04 Oct 2013
Reason:		Ticket overview for Woolworths tickets for Nasiefa
...
--select * from dbo.vwTicketsOverview_Woolworths
AS
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[vwTicketsOverview_Woolworths] TO PUBLIC
    AS [dbo];
