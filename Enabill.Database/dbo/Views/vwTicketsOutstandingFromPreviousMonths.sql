...
CREATE VIEW vwTicketsOutstandingFromPreviousMonths

--select * from vwTicketsOutstandingFromPreviousMonths
AS


-- open tickets for previous months
select 
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[vwTicketsOutstandingFromPreviousMonths] TO PUBLIC
    AS [dbo];
