...
CREATE VIEW [dbo].[vwTicketsOverview_MMI]
/*------------------------------------------------------------------------
Create by:	Izaan Mobey
ON:			28 March 2014
Reason:		Ticket overview for MMI tickets for Nasiefa
...
--select * from dbo.vwTicketsOverview_MMI
AS
...
GO
GRANT SELECT
    ON OBJECT::[dbo].[vwTicketsOverview_MMI] TO PUBLIC
    AS [dbo];
